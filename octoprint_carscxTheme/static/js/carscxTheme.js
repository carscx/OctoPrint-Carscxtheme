...
$(function() {
    ...
    function CarscxThemeViewModel(parameters) {
            ...
            self.tabIcons
                ...
                .map((tab, i) => {
                    ...
                    if (elem$ && elem$.closest('ul').attr('id') === 'tabs') {
                        ...
                        console.warn(
                            `CarscxTheme: Failed to add icon! ${domId()} is not a child of the tab-list!`
                        );
                    }
                });
        };
        ...
        self.onBeforeBinding = function() {
            ...
            self.ownSettings = self.settings.plugins.carscxTheme;
    ...
    OCTOPRINT_VIEWMODELS.push([
        CarscxThemeViewModel,
        ['settingsViewModel'],
        ['#settings_plugin_carscxTheme'],
    ]);
});
